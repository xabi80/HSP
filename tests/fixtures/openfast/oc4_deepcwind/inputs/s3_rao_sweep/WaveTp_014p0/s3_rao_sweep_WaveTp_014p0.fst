...
---------------------- INPUT FILES ---------------------------------------------
"s3_rao_sweep_WaveTp_014p0_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
"s3_rao_sweep_WaveTp_014p0_BeamDyn.dat" BDBldFile(1) - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"s3_rao_sweep_WaveTp_014p0_BeamDyn.dat" BDBldFile(2) - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"s3_rao_sweep_WaveTp_014p0_BeamDyn.dat" BDBldFile(3) - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
...
"s3_rao_sweep_WaveTp_014p0_SeaState.dat" SeaStFile   - Name of file containing sea state input parameters (quoted string)
"s3_rao_sweep_WaveTp_014p0_HydroDyn.dat" HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
