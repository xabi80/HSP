...
---------------------- INPUT FILES ---------------------------------------------
"s4_moored_eq_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
"s4_moored_eq_BeamDyn.dat" BDBldFile(1) - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"s4_moored_eq_BeamDyn.dat" BDBldFile(2) - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"s4_moored_eq_BeamDyn.dat" BDBldFile(3) - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
...
"s4_moored_eq_SeaState.dat" SeaStFile   - Name of file containing sea state input parameters (quoted string)
"s4_moored_eq_HydroDyn.dat" HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"unused"               SubFile     - Name of file containing sub-structural input parameters (quoted string)
"s4_moored_eq_MoorDyn.dat" MooringFile - Name of file containing mooring system input parameters (quoted string)
"unused"               IceFile     - Name of file containing ice input parameters (quoted string)
---------------------- OUTPUT --------------------------------------------------
False                  SumPrint    - Print summary data to "<RootName>.sum" (flag)
1.0                    SttsTime    - Amount of time between screen status messages (s)
1000.0                 ChkptTime   - Amount of time between creating checkpoint files for potential restart (s)
